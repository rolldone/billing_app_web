...
export class RegisterClass extends BaseStateClass<StateType, PropType> {
  ...
  return <div className="page page-center">
    <div className="container container-tight py-4">
        ...
        <div className="card-body">
          ...
          <div className="mb-3">
            ...
            <input
              type="text"
              name="name"
              value={methods.state.form_data.name}
          ...
          <div className="mb-3">
            <label className="form-check">
              <input
                name="term_police_status"
                checked={methods.state.form_data.term_police_status == true}
                onChange={methods.handleFormChange.bind(methods, {})}
                type="checkbox"
      ...
      <div className="text-center text-secondary mt-3">
        ...
        <Link to={ROUTE_CLICK["user.login"]} tabIndex={-1}>
          Sign in
        </Link>
      </div>
    </div>
